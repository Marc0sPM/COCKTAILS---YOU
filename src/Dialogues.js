export const dialogues = {
    ...
    "morado": ["Me encanta descomponer problemas y encontrar soluciones precisas. ¿Puedes hacer lo mismo con mi bebida?",
                "Soy detallista y siempre busco el equilibrio perfecto en todo. Mi cóctel debe ser como una obra maestra bien estructurada.",
                "Prefiero experiencias que despierten mi mente. Quiero un cóctel que sea como resolver un enigma en cada sorbo.",
                "Me gusta descubrir patrones en todo. ¿Puedes sorprenderme con un cóctel que tenga una combinación única de sabores?"],

    "verde": ["Mi personalidad es tranquila y equilibrada. Busco un cóctel que refleje esa armonía en cada trago.",
                "Siempre busco la paz y el consenso. ¿Puedes preparar un cóctel que sea como una alianza perfecta de sabores?",
                "Me encanta unir fuerzas y celebrar la colaboración. Mi cóctel debe ser como un tratado de sabores que trabajan juntos.",
                "Prefiero experiencias suaves y agradables. ¿Puedes hacer un cóctel que sea como un acuerdo perfecto entre ingredientes?"],
